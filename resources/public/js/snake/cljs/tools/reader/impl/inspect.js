...
var l = (cljs.core.truth_(truncate)?(0):(function (){var x__31148__auto__ = (10);
var y__31149__auto__ = n;
...
cljs.tools.reader.impl.inspect.inspect_STAR_ = (function (){var method_table__31844__auto__ = cljs.core.atom.cljs$core$IFn$_invoke$arity$1(cljs.core.PersistentArrayMap.EMPTY);
var prefer_table__31845__auto__ = cljs.core.atom.cljs$core$IFn$_invoke$arity$1(cljs.core.PersistentArrayMap.EMPTY);
var method_cache__31846__auto__ = cljs.core.atom.cljs$core$IFn$_invoke$arity$1(cljs.core.PersistentArrayMap.EMPTY);
var cached_hierarchy__31847__auto__ = cljs.core.atom.cljs$core$IFn$_invoke$arity$1(cljs.core.PersistentArrayMap.EMPTY);
var hierarchy__31848__auto__ = cljs.core.get.cljs$core$IFn$_invoke$arity$3(cljs.core.PersistentArrayMap.EMPTY,cljs.core.cst$kw$hierarchy,cljs.core.get_global_hierarchy());
return (new cljs.core.MultiFn(cljs.core.symbol.cljs$core$IFn$_invoke$arity$2("cljs.tools.reader.impl.inspect","inspect*"),cljs.tools.reader.impl.inspect.dispatch_inspect,cljs.core.cst$kw$default,hierarchy__31848__auto__,method_table__31844__auto__,prefer_table__31845__auto__,method_cache__31846__auto__,cached_hierarchy__31847__auto__));
})();
}
...
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1("\""),cljs.core.str.cljs$core$IFn$_invoke$arity$1(x.substring((0),(function (){var x__31148__auto__ = n;
var y__31149__auto__ = x.length;
return ((x__31148__auto__ < y__31149__auto__) ? x__31148__auto__ : y__31149__auto__);
