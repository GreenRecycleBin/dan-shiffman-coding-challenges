...
var vec__37542 = axis;
var a_x = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37542,(0),null);
var a_y = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37542,(1),null);
var a_z = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37542,(2),null);
var vec__37545 = v;
var x = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37545,(0),null);
var y = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37545,(1),null);
var z = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37545,(2),null);
 ...
 */
quil.middlewares.navigation_3d.cross_product = (function quil$middlewares$navigation_3d$cross_product(p__37557,p__37558){
var vec__37559 = p__37557;
var u1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37559,(0),null);
var u2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37559,(1),null);
var u3 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37559,(2),null);
var vec__37562 = p__37558;
var v1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37562,(0),null);
var v2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37562,(1),null);
var v3 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37562,(2),null);
...
return cljs.core.mapv.cljs$core$IFn$_invoke$arity$2((function (p1__37570_SHARP_){
return (p1__37570_SHARP_ * mult);
}),v);
});
/**
 * Sum of 2 vectors.
...
return quil.middlewares.navigation_3d.rotate_by_axis_and_angle(p1__37584_SHARP_,axis,angle);
});})(axis))
;
...
return quil.middlewares.navigation_3d.rotate_ud(quil.middlewares.navigation_3d.rotate_lr(p1__37591_SHARP_,angle_lr),angle_ud);
...
var map__37603 = cljs.core.cst$kw$navigation_DASH_3d.cljs$core$IFn$_invoke$arity$1(state);
var map__37603__$1 = ((((!((map__37603 == null)))?((((map__37603.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__37603.cljs$core$ISeq$)))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__37603):map__37603);
var up = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__37603__$1,cljs.core.cst$kw$up);
var straight = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__37603__$1,cljs.core.cst$kw$straight);
var temp__5455__auto__ = (function (){var pred__37606 = cljs.core._EQ_;
var expr__37607 = cljs.core.cst$kw$key.cljs$core$IFn$_invoke$arity$1(event);
if(cljs.core.truth_((function (){var G__37610 = cljs.core.cst$kw$w;
var G__37611 = expr__37607;
return (pred__37606.cljs$core$IFn$_invoke$arity$2 ? pred__37606.cljs$core$IFn$_invoke$arity$2(G__37610,G__37611) : pred__37606(G__37610,G__37611));
})())){
return straight;
} else {
if(cljs.core.truth_((function (){var G__37612 = cljs.core.cst$kw$s;
var G__37613 = expr__37607;
return (pred__37606.cljs$core$IFn$_invoke$arity$2 ? pred__37606.cljs$core$IFn$_invoke$arity$2(G__37612,G__37613) : pred__37606(G__37612,G__37613));
})())){
return quil.middlewares.navigation_3d.v_opposite(straight);
} else {
if(cljs.core.truth_((pred__37606.cljs$core$IFn$_invoke$arity$2 ? pred__37606.cljs$core$IFn$_invoke$arity$2(quil.middlewares.navigation_3d.space,expr__37607) : pred__37606(quil.middlewares.navigation_3d.space,expr__37607)))){
return quil.middlewares.navigation_3d.v_opposite(up);
} else {
if(cljs.core.truth_((function (){var G__37615 = cljs.core.cst$kw$z;
var G__37616 = expr__37607;
return (pred__37606.cljs$core$IFn$_invoke$arity$2 ? pred__37606.cljs$core$IFn$_invoke$arity$2(G__37615,G__37616) : pred__37606(G__37615,G__37616));
})())){
return up;
} else {
if(cljs.core.truth_((function (){var G__37618 = cljs.core.cst$kw$d;
var G__37619 = expr__37607;
return (pred__37606.cljs$core$IFn$_invoke$arity$2 ? pred__37606.cljs$core$IFn$_invoke$arity$2(G__37618,G__37619) : pred__37606(G__37618,G__37619));
})())){
return quil.middlewares.navigation_3d.cross_product(straight,up);
} else {
if(cljs.core.truth_((function (){var G__37621 = cljs.core.cst$kw$a;
var G__37622 = expr__37607;
return (pred__37606.cljs$core$IFn$_invoke$arity$2 ? pred__37606.cljs$core$IFn$_invoke$arity$2(G__37621,G__37622) : pred__37606(G__37621,G__37622));
})())){
...
return cljs.core.update_in.cljs$core$IFn$_invoke$arity$3(state,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$navigation_DASH_3d,cljs.core.cst$kw$position], null),((function (dir,temp__5455__auto__,map__37603,map__37603__$1,up,straight){
return (function (p1__37601_SHARP_){
return quil.middlewares.navigation_3d.v_plus(p1__37601_SHARP_,quil.middlewares.navigation_3d.v_mult(dir,step_size));
});})(dir,temp__5455__auto__,map__37603,map__37603__$1,up,straight))
);
} else {
return state;
}
...
return cljs.core.update_in.cljs$core$IFn$_invoke$arity$3((user_setup.cljs$core$IFn$_invoke$arity$0 ? user_setup.cljs$core$IFn$_invoke$arity$0() : user_setup()),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$navigation_DASH_3d], null),((function (initial_state){
return (function (p1__37642_SHARP_){
return cljs.core.merge.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([initial_state,p1__37642_SHARP_], 0));
});})(initial_state))
);
});
/**
...
var rotate_on_fn = (function (){var G__37667 = options;
var G__37668 = ((function (G__37667,user_settings,pixels_in_360,step_size,rotate_on,draw,key_pressed){
return (function (state,_){
return state;
});})(G__37667,user_settings,pixels_in_360,step_size,rotate_on,draw,key_pressed))
;
return (rotate_on.cljs$core$IFn$_invoke$arity$2 ? rotate_on.cljs$core$IFn$_invoke$arity$2(G__37667,G__37668) : rotate_on(G__37667,G__37668));
})();
...
var map__37671_37721 = cljs.core.cst$kw$navigation_DASH_3d.cljs$core$IFn$_invoke$arity$1(state);
var map__37671_37722__$1 = ((((!((map__37671_37721 == null)))?((((map__37671_37721.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__37671_37721.cljs$core$ISeq$)))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__37671_37721):map__37671_37721);
var vec__37672_37723 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__37671_37722__$1,cljs.core.cst$kw$straight);
var c_x_37724 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37672_37723,(0),null);
var c_y_37725 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37672_37723,(1),null);
var c_z_37726 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37672_37723,(2),null);
var vec__37675_37727 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__37671_37722__$1,cljs.core.cst$kw$up);
var u_x_37728 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37675_37727,(0),null);
var u_y_37729 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37675_37727,(1),null);
var u_z_37731 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37675_37727,(2),null);
var vec__37678_37734 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__37671_37722__$1,cljs.core.cst$kw$position);
var p_x_37735 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37678_37734,(0),null);
var p_y_37736 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37678_37734,(1),null);
var p_z_37737 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37678_37734,(2),null);
quil.core.camera.cljs$core$IFn$_invoke$arity$9(p_x_37735,p_y_37736,p_z_37737,(p_x_37735 + c_x_37724),(p_y_37736 + c_y_37725),(p_z_37737 + c_z_37726),u_x_37728,u_y_37729,u_z_37731);

return (draw.cljs$core$IFn$_invoke$arity$1 ? draw.cljs$core$IFn$_invoke$arity$1(state) : draw(state));
...
var G__37698 = quil.middlewares.navigation_3d.move(state,event,step_size);
var G__37699 = event;
return (key_pressed.cljs$core$IFn$_invoke$arity$2 ? key_pressed.cljs$core$IFn$_invoke$arity$2(G__37698,G__37699) : key_pressed(G__37698,G__37699));
});})(user_settings,pixels_in_360,step_size,rotate_on,draw,key_pressed,rotate_on_fn,setup))
,rotate_on,((function (user_settings,pixels_in_360,step_size,rotate_on,draw,key_pressed,rotate_on_fn,setup){
return (function (state,event){
var G__37703 = quil.middlewares.navigation_3d.rotate(state,event,pixels_in_360);
var G__37704 = event;
return (rotate_on_fn.cljs$core$IFn$_invoke$arity$2 ? rotate_on_fn.cljs$core$IFn$_invoke$arity$2(G__37703,G__37704) : rotate_on_fn(G__37703,G__37704));
});})(user_settings,pixels_in_360,step_size,rotate_on,draw,key_pressed,rotate_on_fn,setup))
], 0));
});
