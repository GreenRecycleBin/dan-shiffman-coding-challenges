...
return (function (){
return cljs.core.reset_BANG_(quil.core.state_atom(),(setup.cljs$core$IFn$_invoke$arity$0 ? setup.cljs$core$IFn$_invoke$arity$0() : setup()));
});})(setup))
);
});
...
return (function (){
var G__37541 = cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$2(quil.core.state_atom(),((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(quil.core.frame_count(),(1)))?cljs.core.identity:update));
return (draw.cljs$core$IFn$_invoke$arity$1 ? draw.cljs$core$IFn$_invoke$arity$1(G__37541) : draw(G__37541));
});})(draw,update))
;
...
var temp__5455__auto__ = (options.cljs$core$IFn$_invoke$arity$1 ? options.cljs$core$IFn$_invoke$arity$1(handler_key) : options(handler_key));
...
return (function (){
return cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$3(quil.core.state_atom(),handler,(event_fn.cljs$core$IFn$_invoke$arity$0 ? event_fn.cljs$core$IFn$_invoke$arity$0() : event_fn()));
...
var len__32068__auto___37579 = arguments.length;
var i__32069__auto___37580 = (0);
while(true){
if((i__32069__auto___37580 < len__32068__auto___37579)){
args__32075__auto__.push((arguments[i__32069__auto___37580]));

var G__37581 = (i__32069__auto___37580 + (1));
i__32069__auto___37580 = G__37581;
continue;
} else {
}
break;
...
return quil.middlewares.fun_mode.wrap_handlers.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),argseq__32076__auto__);
});
...
quil.middlewares.fun_mode.wrap_handlers.cljs$lang$applyTo = (function (seq37566){
var G__37567 = cljs.core.first(seq37566);
var seq37566__$1 = cljs.core.next(seq37566);
return quil.middlewares.fun_mode.wrap_handlers.cljs$core$IFn$_invoke$arity$variadic(G__37567,seq37566__$1);
});
