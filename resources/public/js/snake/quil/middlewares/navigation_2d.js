...
return cljs.core.update_in.cljs$core$IFn$_invoke$arity$3((user_setup.cljs$core$IFn$_invoke$arity$0 ? user_setup.cljs$core$IFn$_invoke$arity$0() : user_setup()),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$navigation_DASH_2d], null),((function (initial_state){
return (function (p1__38331_SHARP_){
return cljs.core.merge.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([initial_state,p1__38331_SHARP_], 0));
});})(initial_state))
);
});
/**
...
var nav_2d_38334 = cljs.core.cst$kw$navigation_DASH_2d.cljs$core$IFn$_invoke$arity$1(state);
var zoom_38335 = cljs.core.cst$kw$zoom.cljs$core$IFn$_invoke$arity$1(nav_2d_38334);
var pos_38336 = cljs.core.cst$kw$position.cljs$core$IFn$_invoke$arity$1(nav_2d_38334);
quil.core.scale.cljs$core$IFn$_invoke$arity$1(zoom_38335);

var tr__38236__auto___38337 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [(((quil.core.width() / (2)) / zoom_38335) - cljs.core.first(pos_38336)),(((quil.core.height() / (2)) / zoom_38335) - cljs.core.second(pos_38336))], null);
quil.core.push_matrix();

try{quil.core.translate.cljs$core$IFn$_invoke$arity$1(tr__38236__auto___38337);

(user_draw.cljs$core$IFn$_invoke$arity$1 ? user_draw.cljs$core$IFn$_invoke$arity$1(state) : user_draw(state));
...
var G__38338 = quil.middlewares.navigation_2d.mouse_dragged(state,event);
var G__38339 = event;
return (user_mouse_dragged.cljs$core$IFn$_invoke$arity$2 ? user_mouse_dragged.cljs$core$IFn$_invoke$arity$2(G__38338,G__38339) : user_mouse_dragged(G__38338,G__38339));
...
return (function (state,event){
var G__38340 = quil.middlewares.navigation_2d.mouse_wheel(state,event);
var G__38341 = event;
return (user_mouse_wheel.cljs$core$IFn$_invoke$arity$2 ? user_mouse_wheel.cljs$core$IFn$_invoke$arity$2(G__38340,G__38341) : user_mouse_wheel(G__38340,G__38341));
});})(user_settings,user_draw,user_mouse_dragged,user_mouse_wheel,setup))
], 0));
});
